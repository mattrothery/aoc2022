...
def play(player, elf):
    ...
    if player == 'X' and elf == 'A':
        return 3
    elif player == 'Y' and elf == 'B':
        return 3
    elif player == 'Z' and elf == 'C':
        return 3
    elif player == 'X' and elf == 'C':
        return 6
    elif player == 'Y' and elf == 'A':
        return 6
    elif player == 'Z' and elf == 'B':
        return 6
    else:
        return 0
